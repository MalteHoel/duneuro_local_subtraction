...
int main(int argc, char** argv)
{
  ...
  config["referenceFilename"] = "reference_solutions/EEG/DG/eeg_subtraction_reference_solution_dg_tet.txt";
  
  double threshold = 1e-8;
  
  config["driver.source_model.type"] = "subtraction";
  config["driver.source_model.intorderadd"] = "5";
  config["driver.source_model.intorderadd_lb"] = "5";
