...
int main(int argc, char** argv)
{
  ...
  config["referenceFilename"] = "reference_solutions/MEG/CG/meg_subtraction_reference_solution_cg_tet.txt";
  
  double threshold = 1e-4;
  
  config["driver.source_model.type"] = "subtraction";
  config["driver.source_model.intorderadd"] = "3";
  config["driver.source_model.intorderadd_lb"] = "4";
