...
namespace duneuro
{
  ...
  public:
    ...
    explicit FittedVolumeConductor(const Dune::ParameterTree& config, DataTree dataTree = DataTree())
        : FittedVolumeConductor(FittedDriverData<dim>{}, config, dataTree)
    {
    }

    explicit FittedVolumeConductor(const FittedDriverData<dim>& data, const Dune::ParameterTree& config,
    ...
    virtual void solveEEGForward(const typename VolumeConductorInterface<dim>::DipoleType& dipole,
    ...
    virtual void
    setElectrodes(const std::vector<typename VolumeConductorInterface<dim>::CoordinateType>& electrodes,
    ...
    virtual void setCoilsAndProjections(
        const std::vector<typename VolumeConductorInterface<dim>::CoordinateType>& coils,
        const std::vector<std::vector<typename VolumeConductorInterface<dim>::CoordinateType>>&
