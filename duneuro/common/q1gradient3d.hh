#ifndef DUNEURO_Q1_GRADIENT_3D_HH
#define DUNEURO_Q1_GRADIENT_3D_HH
...
namespace duneuro
{
  ...
  class Q1Gradient3DLocalInterpolation
  {
  public:
    ...
    Q1Gradient3DLocalInterpolation(const Dune::GeometryType& gt_, const LB& lb_)
  ...
  class Q1Gradient3DLocalCoefficients
  {
  public:
    //! \brief Standard constructor
    Q1Gradient3DLocalCoefficients() : li(7)
    {
  ...
  template <class D, class R>
  class Q1Gradient3DLocalFiniteElement
  {
    typedef Q1Gradient3DLocalBasis<D, R> LocalBasis;
    typedef Q1Gradient3DLocalCoefficients LocalCoefficients;
    typedef Q1Gradient3DLocalInterpolation<LocalBasis, 7> LocalInterpolation;
  ...
  public:
    ...
    Q1Gradient3DLocalFiniteElement* clone() const
    {
      return new Q1Gradient3DLocalFiniteElement(*this);
    }
...
#endif // DUNEURO_Q1_GRADIENT_3D_HH
