#ifndef DUNEURO_P1_GRADIENT_2D_HH
#define DUNEURO_P1_GRADIENT_2D_HH
...
namespace duneuro
{
  ...
  class P1Gradient2DLocalInterpolation
  {
  public:
    ...
    P1Gradient2DLocalInterpolation(const Dune::GeometryType& gt_, const LB& lb_)
  ...
  class P1Gradient2DLocalCoefficients
  {
  public:
    //! \brief Standard constructor
    P1Gradient2DLocalCoefficients() : li(2)
    {
  ...
  template <class D, class R>
  class P1Gradient2DLocalFiniteElement
  {
    typedef P1Gradient2DLocalBasis<D, R> LocalBasis;
    typedef P1Gradient2DLocalCoefficients LocalCoefficients;
    typedef P1Gradient2DLocalInterpolation<LocalBasis, 2> LocalInterpolation;
  ...
  public:
    ...
    /** \todo Please doc me !
     */
    P1Gradient2DLocalFiniteElement()
      : gt(Dune::GeometryTypes::simplex(2)), basis(), coefficients(), interpolation(gt, basis)
    {
    }
    ...
    P1Gradient2DLocalFiniteElement* clone() const
    {
      return new P1Gradient2DLocalFiniteElement(*this);
    }
...
#endif // DUNEURO_P1_GRADIENT_2D_HH
